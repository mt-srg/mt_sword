...
EOF;
            ...
            if($item[3] == "tcp" and $item[17] == "yes") {
                $SS_Server_config = <<<EOF
{
  "server":"127.0.0.1",
...
EOF;
                $SS_config[$item[11]] = array($SS_Server_config, $SS_Client_config);



            }
		}
		return array($configuration, $SS_config);
	}
}
